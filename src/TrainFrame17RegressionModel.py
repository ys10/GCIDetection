...
class TrainFrame17RegressionModel(object):
    def __init__(self):
        ...
        self.resultFilename = "data/hdf5/APLAWDW_frame_17_regression_result.hdf5"
        self.modelRestorePath = None
        self.modelSavePath = "model/APLAWDW_frame_17_regression_model"
        self.summarySavePath = "summary/APLAWDW_frame_17_regression_model/"
        pass
...
def main():
    frameModel = TrainFrame17RegressionModel()
    frameModel.run()
    pass
